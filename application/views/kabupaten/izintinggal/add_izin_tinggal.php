        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="izintinggal/data_itk/<?php echo hashids_encrypt($row['id']);?>/t" enctype="multipart/form-data">
<!--                    <form method="" action="" enctype="">-->
                        ...
                        <div class="text-right">
                            ...
                            <button  class="btn btn-success cur-p" name="btn_simpan_public<?php echo $row['id']?>"
                                    id="btn_simpan_public<?php echo $row['id']?>">
                                Simpan Data ITK
                            </button>
